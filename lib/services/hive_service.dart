...
class HiveService {
  ...
  static late Box _gsheetsCacheBox;
  ...
  static Box get gsheetsCacheBox => _gsheetsCacheBox;
  ...
  static Future<void> init() async {
    ...
    _gsheetsCacheBox = Hive.isBoxOpen('gsheetsCache')
        ? Hive.box('gsheetsCache')
        : await Hive.openBox('gsheetsCache');
  }
