...
class AttemptService {
  ...
  Future<void> saveOrUpdateAttempt(Attempt attempt) async {
    ...
    a.displayTopic.equalsIgnoreCase(attempt.displayTopic) &&
        a.selectedCategory.equalsIgnoreCase(attempt.selectedCategory) &&
        a.displayLevel.equalsIgnoreCase(attempt.displayLevel) &&
        a.displaySubtopic.equalsIgnoreCase(attempt.displaySubtopic) &&
